!function(e) {
  ...
  function(e, t, n) {
    ...
    webix.protoUI({
      ...
      $init: function(e) {
        ...
        webix.extend(e, this.defaults),
        b.init(this, e),
        l.init(this),
        f.init(this),
        e.legacyUploader = e.legacyUploader || webix.isUndefined(XMLHttpRequest) || webix.isUndefined((new XMLHttpRequest).upload),
        this.$ready.push(function() {
          t._beforeInit(),
          t.callEvent("onComponentInit", [])
        }),
        webix.UIManager.tabControl = !0,
        webix.extend(e, b.getUI(this, e)),
        ...
        for (var t in e) {
          ...
          if ("string" == typeof n)
            if (n.indexOf("->") != -1) {
              ...
              "upload" != t && "download" != t && (n = webix.proxy("post", n));
        e[t] = n
        }
        return e
      },
      _beforeInit: function() {
        a.init(this),
        x.init(this),
        this.config.scheme || this.define("scheme", {
          init: function(e) {
      ...
      _getParentId: function(e) {
        if (!this.getItem(e)) {
          var t = this.$$(this.config.mode),
            n = t.getItem(e);
          return n && n.parent && this.getItem(n.parent)
            ? n.parent
            : null
        }
      ...
      _getLocation: function(e) {
        ...
        if (this.getItem(e.id) || e.parent && this.getItem(e.parent)) {
          e.parent
            ? (t = this.getPathNames(e.parent), t.shift())
            : (t = this.getPathNames(e.id), t.shift(), t.pop());
      ...
      showSearchResults: function(e) {
        ...
        if (this.config.handlers.search)
          f.loadSearchData(this, this.config.handlers.search, t, e);
        else {
      ...
      levelUp: function(e) {
        e = e || this.getCursor(),
        e && (e = this.getParentId(e), this.setCursor(e))
      },
      markCopy: function(e) {
      ...
      pasteFile: function(e) {
        if (webix.isArray(e) && (e = e[0]), e) {
          ...
          (this.data.branch[e] && "folder" == this.getItem(e).type || t && "folder" == t.type) && this._moveData && (
            this._copyFiles
            ? this.copyFile(this._moveData, e)
            : this.moveFile(this._moveData, e))
        }
      },
      download: function(e) {
      ...
      _refreshActiveFolder: function() {
        this.$skipDynLoading = !0,
        this.$$(this.config.mode).$skipBinding = !1,
        this.refreshCursor()
      },
      _setFSId: function(e) {
      ...
      _moveFile: function(e, t, n) {
        ...
        s && g.makeSaveRequest(this, s, {
          ...
          if (t && webix.isArray(t))
            for (var n = e.temp.split(","), i = 0; i < t.length; i++)
              t[i].id && t[i].id != n[i] && this.data.pull[n[i]] && (this.data.changeId(n[i], t[i].id), this.config.fsIds && this._changeChildIds(t[i].id), t[i].value && this._callbackRename(t[i].id, t[i].value));
      ...
      moveFile: function(e, t, n) {
        var i,
          ...
          a;
        for (
          "string" == typeof e && (e = e.split(",")), webix.isArray(e) || (e = [e]), t
          ? this.data.branch[t] || "folder" == this.getItem(t.toString()).type || (t = this.getParentId(t))
          : t = this.getCursor(),
        a = !0,
        t = t.toString(),
        i = 0; i < e.length; i++)
          o = e[i].toString(),
          a = a && this._isMovingAllowed(o, t);
        a
          ? this._moveFile(e, t, !!n)
          : this.callEvent(
            n
            ? "onCopyError"
            : "onMoveError",
      ...
      deleteFile: function(e, t) {
        ...
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          this.$$(this.config.mode).isSelected(i) && this.$$(this.config.mode).unselect(i),
          i == this.getCursor() && this.setCursor(this.getFirstId()),
          i && this.remove(i)
        }
        this._refreshActiveFolder();
        var o = this.config.handlers.remove;
        o
          ? (t && (t = webix.bind(t, this)), g.makeSaveRequest(this, o, {
            action: "remove",
            source: e.join(","),
            command: "filesystem"
          }, t))
      ...
      createFolder: function(e) {
        if ("string" == typeof e && (e = e.split(",")), webix.isArray(e) && (e = e[0]), e) {
          ...
          e = "" + e,
          this._createFolder(n, e)
        }
      },
      editFile: function(e) {
        webix.isArray(e) && (e = e[0]),
        this.getActiveView() && this.getActiveView().edit && this.getActiveView().edit(e)
      },
      renameFile: function(e, t, n) {
        ...
        if (o) {
          ...
          g.makeSaveRequest(this, o, a, function(e, t) {
            t.id && this.getItem(e.source) && (e.source != t.id && this.data.changeId(e.source, t.id), this.config.fsIds && this._changeChildIds(t.id), t.value && this._callbackRename(t.id, t.value)),
            this._updateDynSearch()
          })
        }
      },
      _isMovingAllowed: function(e, t) {
        for (; t;) {
          if (t == e || !this.data.branch[t] && "folder" != this.getItem(t.toString()).type)
            return !1;
      ...
      _onFileDblClick: function(e) {
        ...
        var t = this.getItem(e);
        if (t)
          this.data.branch[e] || "folder" == t.type
            ? this._openFolder(e)
            : this._runFile(e);
        else if (this.$$(this.config.mode).filter)
          if (t = this.$$(this.config.mode).getItem(e), "folder" != t.type)
            this._runFile(e);
          else {
            var n = t && t.parents
              ? t.parents
              : h.getParentFolders(e);
    ...
    webix.type(webix.ui.tree, {
      ...
      icon: function(e) {
        for (var t = "", n = 1; n < e.$level; n++)
          t += "<div class='webix_tree_none'></div>";
        return t += e.webix_child_branch && !e.$count
          ? "<div class='webix_tree_child_branch webix_fmanager_icon webix_tree_close'></div>"
          : e.$count > 0
            ? e.open
              ? "<div class='webix_fmanager_icon webix_tree_open'></div>"
              : "<div class='webix_fmanager_icon webix_tree_close'></div>"
            : "<div class='webix_tree_none'></div>"
      },
      folder: function(e) {
        return e.$count && e.open
          ? "<div class='webix_fmanager_icon webix_folder_open'></div>"
          : "<div class='webix_fmanager_icon webix_folder'></div>"
      }
    }),
    ...
    webix.protoUI({
      ...
      $dragHTML: function(e, t) {
        var n = webix.DragControl.getContext(),
          ...
          s = t.x - r.x;
        return n.x_offset = s > a.width
          ? -a.width / 4
          : -s,
        n.y_offset = -a.height / 2,
        "<div class='webix_tree_item webix_fmanager_drag' style='width:auto'>" + o + "</div>"
      }
  ...
  function(e, t) {
    ...
    webix.protoUI({
      ...
      setValue: function(e) {
        this.clearAll(),
        e && ("string" == typeof e && (e = e.split(this.config.separator)), this.parse(webix.copy(e)))
      },
      getValue: function() {
  ...
  function(e, t) {
    ...
    function i(e) {
      ...
      e.callEvent("onViewInit", ["actions", a]),
      e._contextMenu = e.ui(a),
    ...
    function o(e) {
      ...
      t && (t.attachEvent("onItemClick", function(n, i) {
        ...
        if (a) {
          var r = e.getActive();
          if (e.callEvent("onbefore" + (
          o.event || o.method || n), [r])) {
            "upload" == n && e.config.legacyUploader || (e._uploadPopup && e._uploadPopup.hide(), t.hide());
            var s = [r];
            "upload" == n && (i = webix.html.pos(i), s.push(i)),
        ...
        t.hide();
        var n = t.getContext();
        return n && n.obj && !n.id && n.obj.unselectAll(),
        !n || !n.obj || n.obj.callEvent("onBeforeMenuShow", [n.id, e])
      }))
    }
    t.__esModule = !0,
    t.init = i
  ...
  function(e, t) {
    ...
    t.values = {
      ...
      templateSize: function(e) {
        for (var t = e.size, n = webix.i18n.filemanager.sizeLabels, i = 0; t / 1024 > 1;)
          t /= 1024,
          i++;
      ...
      templateDate: function(e) {
        ...
        return "object" != (
          "undefined" == typeof t
          ? "undefined"
          : n(t)) && (t = new Date(1e3 * parseInt(e.date, 10))),
        webix.i18n.fullDateFormatStr(t)
      },
      ...
      templateIcon: function(e, t) {
        let tIcon = ""
        let tableMode = false
        if ($('.webix_fmanager_table').length > 0) {
            tableMode = true
        }
        if (!tableMode && e.thumbnail_url !== undefined && e.thumbnail_url !== null) {
          tIcon = "<img src='"+e.thumbnail_url+"'>"
              return "<div class='webix_fmanager_icon'>"+tIcon+"</div>"
        }
        // if (e.type === 'webview' && e.thumbnail_url !== undefined && e.thumbnail_url !== null) {
        //     tIcon = "<img src='"+e.thumbnail_url+"'>"
        //     return "<div class='webix_fmanager_icon " + e.thumbnail_url + "'></div>"
        // }
        // return "<div class='webix_fmanager_icon fm-" + (t.icons[e.type] || t.icons.file) + "'>"+tIcon+"</div>"
        return "<div class='webix_fmanager_icon fm-" + (
        t.icons[e.type] || t.icons.file) + "'></div>"
      },
      uploadProgress: {
        type: "icon",
        hide: !1
  ...
  function(e, t) {
    "use strict";
    function n(e) {
      e._cursorHistory = webix.extend([], webix.PowerArray, !0),
    ...
    function i(e) {
      ...
      e.attachEvent("onAfterCursorChange", function(t) {
        e._historyIgnore || (e._historyCursor || e._cursorHistory.splice(1), e._cursorHistory[this._historyCursor] != t && (20 == e._cursorHistory.length && e._cursorHistory.splice(0, 1), e._cursorHistory.push(t), e._historyCursor = this._cursorHistory.length - 1)),
        e._historyIgnore = !1,
        e.config.disabledHistory || o(e, t),
        e.callEvent("onHistoryChange", [t, e._cursorHistory, e._historyCursor])
      })
    }
    function o(e, t) {
      t = t || e.getCursor(),
  ...
  function(e, t, n) {
    ...
    function a(e) {
      e.dataParser = {
        ...
        branch: function(e, t) {
          this.config.noFileCache
            ? s(this, e.id)
            : (e.webix_branch = 0, e.webix_child_branch = 0),
          c(this, t)
        }
      }
    }
      ...
      if (e.showProgress(), e.callEvent("onBeforeDynLoad", [t, n, i, o])) {
        var a = {
          success: function(t, a) {
            ...
            o && (n.open = !0),
            e.callEvent("onBeforeDynParse", [n, r, i]) && (e.dataParser[i].call(e, n, r), e.callEvent("onAfterDynParse", [n, r, i]))
          },
          error: function() {
            e.hideProgress(),
            e.callEvent("onDynLoadError", [])
          }
        };
        if (t.load)
          return t.load(null, a, {
            action: i,
            source: n.id
          })
      }
    ...
    function l(e, t) {
      ...
      if (n = f(e), n && t.length) {
        for (i = 0; i < t.length; i++) {
          if (o = e.getItem(t[i]), !o || o["webix_" + n])
            return u(e, t.slice(i), n, a),
            a;
          o.open = !0,
          e.$$("tree") && e.$$("tree").refresh(t[i])
        }
        a.resolve(t[i])
      } else
        a.reject();
        ...
        r = {
          success: function(a, r) {
            ...
            if (e.callEvent("onBeforeDynParse", [o, s, n])) {
              o.open = !0,
              e.dataParser[n].call(e, o, s);
              var c = t.shift();
              t.length && "folder" == e.getItem(t[0]).type
                ? u(e, t, n, i)
                : (e.refreshCursor(), i.resolve(c)),
              e.callEvent("onAfterDynParse", [o, s, n])
            }
          }
        };
      if (a.load)
        return a.load(null, r, {
          action: n,
          source: t[0]
        })
    }
    ...
    function d(e, t, n, i) {
      ...
      if (e.callEvent("onBeforeSearchRequest", [n, o])) {
        ...
        if (t.load)
          return t.load(null, a, o)
      }
    }
    function h(e, t) {
      e.callEvent("onShowSearchResults", []),
      e.$searchResults = !0;
  ...
  function(e, t) {
    "use strict";
    function n(e, t) {
      for (var n = webix.DataStore.prototype.sorting.create(e), i = [], o = [], a = 0; a < t.length; a++)
        "folder" == t[a].type
          ? i.push(t[a])
          : o.push(t[a]);
      return i.sort(n),
  ...
  function(e, t) {
    ...
    function i(e, t) {
      t = t || e.getCursor();
      for (var n = null, i = []; t && e.getItem(t);)
        n = e.getItem(t),
        i.push({id: t, value: e.config.templateName(n)}),
        t = e.getParentId(t);
      return i.reverse()
    }
    function o(e, t) {
      for (var n = t; n && e.getItem(n);)
        e.callEvent("onPathLevel", [n]),
        n = e.getParentId(n);
      if (e.getItem(t))
        t != e.getCursor() && (e.setCursor(t), e.callEvent("onPathComplete", [t]));
      else {
        var i = a(t);
        e.openFolders(i).then(function() {
          e.setCursor(t),
          e.callEvent("onPathComplete", [t])
        })
      }
    }
    function a(e) {
      var t,
        ...
        i = [];
      if ("string" == typeof e)
        for (n = e.replace(/^\//, "").split("/"), t = 0; t < n.length; t++)
          i.push(n.slice(0, t + 1).join("/"));
    return i
    }
    t.__esModule = !0,
    t.getPath = n,
  ...
  function(e, t) {
      ...
      if (e.callEvent("onBeforeRequest", [t, n]) && (i(e), t.load)) {
        var s = {
          success: function(t, i) {
            ...
            o(e),
            e.callEvent("onSuccessResponse", [n, a]) && r && r.call(e, n, a)
          },
          error: function(t) {
    ...
    function i(e, t) {
      e._saveMessageDate = new Date,
      e._saveMessage || (e._saveMessage = webix.html.create("DIV", {
        "class": "webix_fmanager_save_message"
      }, ""), e.$view.style.position = "relative", webix.html.insertBefore(e._saveMessage, e.$view));
      var n = "";
      n = t
        ? webix.i18n.filemanager.errorResponse
        : webix.i18n.filemanager.saving,
      e._saveMessage.innerHTML = n
    }
    function o(e) {
  ...
  function(e, t, n) {
    ...
    function a(e, t, n) {
      ...
      for (s = 0; s < u.length; s++)
        t[u[s]] && (l = u[s], i = t[l]);
      if (i)
        for ("string" == typeof i && e.structure[i] && (t[l] = r(e, e.structure[i], n), i = t[l]), s = 0; s < i.length; s++)
          o = null,
          "string" == typeof i[s] && (
            o = c = i[s], e.structure[c]
            ? (i[s] = r(e, webix.extend({}, e.structure[c]), n), i[s].id = c)
            : i[s] = {}),
          a(e, i[s], n),
          o && (n.on && n.on.onViewInit && n.on.onViewInit.apply(this, [
            o, i[s]
          ]), webix.callEvent("onViewInit", [o, i[s], this]))
    }
    function r(e, t, n) {
      var i = t.config || t;
    ...
    function c(e, t) {
      ...
      return a(e, i, t),
      t.on && t.on.onViewInit && t.on.onViewInit.apply(e, [
        t.id || "mainLayout",
        i
      ]),
      webix.callEvent("onViewInit", [
        t.id || "mainLayout",
        i,
        e
      ]),
    ...
    function l(e, t) {
      ...
      if (o)
        for (i in o)
          o.hasOwnProperty(i) && (
            n = webix.copy(o[i]), e.structure[i] && e.structure[i].config
            ? e.structure[i].config = n.config || n
            : e.structure[i] = n.config || n)
      }
    t.__esModule = !0,
    t.init = o,
    t.getViews = a,
  ...
  function(e, t) {
    ...
    function i(e) {
      e._getDynMode() && e.$$("collapseAll") && e.$$("collapseAll").hide(),
      e.$$("collapseAll") && e.$$("tree") && e.$$("collapseAll").attachEvent("onItemClick", function() {
        e.$$("tree").closeAll()
      })
    }
    t.__esModule = !0,
  ...
  function(e, t) {
    ...
    function i(e) {
      e._getDynMode() && e.$$("expandAll") && e.$$("expandAll").hide(),
      e.$$("expandAll") && e.$$("tree") && e.$$("expandAll").attachEvent("onItemClick", function() {
        e.$$("tree").openAll()
      })
    }
    t.__esModule = !0,
  ...
  function(e, t) {
    ...
    function n() {
      ...
      return "undefined" == typeof SVGRect && (e.css = "webix_nosvg"),
      e
    }
    t.__esModule = !0,
    t.init = n
  ...
  function(e, t) {
    ...
    function i(e) {
      ...
      t && (t.attachEvent("onItemClick", function() {
        e.callEvent("onBeforeMenu", []) && (e.getMenu().setContext({obj: e.getActiveView(), id: e.getActive()}), e.getMenu().show(t.$view), e.callEvent("onAfterMenu", []))
  ...
  function(e, t, n) {
    ...
    function r(e, t) {
      ...
      f(e, t);
      var n = e.getMenu();
      n && !e.config.readonly && u(e, t, n),
      e.config.readonly && (t.define("drag", !1), t.define("editable", !1))
    }
    function s(e, t) {
      ...
      t.bind(e, "$data", function(n, i) {
        ...
        if (!e.$searchResults) {
          if (!e.$skipDynLoading)
            for (var a in e.dataParser)
              !o && n["webix_" + a] && (o = e.config.handlers[a], o && (e.$skipDynLoading = !0, e.loadDynData(o, n, a)));
        c(e, t, i, n)
        }
      })
    }
    function c(e, t, n, i) {
      ...
      e.sortState && e.sortState.view == t.config.id && (o = h.sortData(e.sortState.sort, o)),
      t.data.importData(o, !0)
    }
    function l(e, t) {
      t.type.icons = e.config.icons,
      t.type.templateIcon = e.config.templateIcon,
      t.type.templateName = e.config.templateName,
      t.type.templateSize = e.config.templateSize,
      t.type.templateDate = e.config.templateDate,
      t.type.templateType = e.config.templateType
    }
    function u(e, t, n) {
      t.on_context.webix_view = function(e, t) {
        t = this.locate(e.target || e.srcElement),
        t || (n.setContext && n.setContext({obj: webix.$$(e)}), n.show(e), webix.html.preventEvent(e))
      },
      n.attachTo(t),
      t.attachEvent("onBeforeMenuShow", function() {
        var t = n.getContext(),
          i = "";
        if (t.id && (
          i = "folder" === e.getItem(t.id).type
          ? "folder"
          : "file"), n.filter(function(t) {
          var n = !0;
          return t.batch && (
            n = i
            ? t.batch == i || "item" == t.batch
            : "empty" == t.batch),
          e.config.menuFilter && (n = n && e.config.menuFilter(t)),
          n
        }), n.count() && t.id) {
      ...
      t.attachEvent("onAfterMenuShow", function(e) {
        if (e) {
          for (var t = this.getSelectedId(!0), n = !1, i = 0; i < t.length && !n; i++)
            t[i].toString() == e.toString() && (n = !0);
          n || this.select(e.toString()),
          webix.UIManager.setFocus(this)
        } else
          this.unselect()
      })
    ...
    function f(e, t) {
      ...
      t.attachEvent("onBeforeEditStop", function(e, t) {
        return this.getTopParentView().callEvent("onBeforeEditStop", [
          t.id || t.row,
          e,
          t,
          this
      ...
      t.attachEvent("onAfterEditStop", function(e, t) {
        ...
        n.callEvent("onAfterEditStop", [
          t.id || t.row,
          e,
          t,
          this
        ]) && (
          t.column && "value" != t.column
          ? t.column && (n.getItem(t.id || t.row)[t.column] = e.value)
          : n.renameFile(t.id || t.row, e.value))
      }),
      ...
      e._addElementHotKey("enter", function(t) {
        for (var n = t.getSelectedId(!0), i = 0; i < n.length; i++)
          e._onFileDblClick(n[i]);
    ...
    function i(e) {
      ...
      t && (e.attachEvent("onHideSearchResults", function() {
        ...
        if (9 != this._code) {
          var n = t.getValue();
          n
            ? e.callEvent("onBeforeSearch", [n]) && (e.showSearchResults(n), e.callEvent("onAfterSearch", [n]))
    ...
    function i(e) {
      e.$$("table") && (e.attachEvent("onHideSearchResults", function() {
        ...
        return "object" == (
          "undefined" == typeof e
          ? "undefined"
          : o(e)) || (this.edit({row: e, column: "value"}), !1)
      }), e.$$("table").data.attachEvent("onBeforeSort", function(t, n, i, o) {
        if (e.sortState = {
          view: e.$$("table").config.id,
          sort: o
        }, e.$searchResults && e.$$("search"))
          return e.showSearchResults(e.$$("search").getValue()),
          !1
      }), e.data.attachEvent("onClearAll", function() {
        e.sortState = null
      }))
    ...
    function i(e) {
      ...
      if (n) {
        ...
        e.attachEvent("onAfterDynParse", function(e, i, o) {
          t && (n.setState(t), t = null),
          "branch" == o && e.open && n.open(e.id)
        }),
        ...
        n.attachEvent("onFocus", function() {
          e._activeView = n,
          webix.html.removeCss(n.$view, "webix_blur"),
          e.$$(e.config.mode).unselect()
        }),
        ...
        e.config.readonly || (e.getMenu() && e.getMenu().attachTo(n), n.attachEvent("onBeforeMenuShow", function(t) {
          var n = e.getMenu(),
            i = n.getContext(),
            o = "";
          return i.id && this.getParentId(i.id) && (
            o = "folder" === e.getItem(i.id).type
            ? "folder"
            : "file"),
          n.filter(function(t) {
            var n = !0;
        ...
        n.attachEvent("onBeforeDrop", function(t, n) {
          return e.callEvent("onBeforeDrop", [t, n]) && t.from && (e.moveFile(t.source, t.target), e.callEvent("onAfterDrop", [t, n])),
          !1
        });
        var i = function() {
          n && webix.UIManager.setFocus(n)
        };
        e.attachEvent("onAfterBack", i),
        e.attachEvent("onAfterForward", i),
        e.attachEvent("onAfterLevelUp", i),
        e.attachEvent("onAfterPathClick", i),
        e.config.readonly && (n.define("drag", !1), n.define("editable", !1))
      }
    }
    t.__esModule = !0,
    t.init = n
  ...
  function(e, t, n) {
    ...
    function a(e) {
      ...
      n && (
        t
        ? s(e, webix.copy(n))
        : (e._uploader = webix.ui(n), e.attachEvent("onDestruct", function() {
    ...
    function r(e) {
      ...
      if (t) {
        ...
        if (n && !e.config.readonly)
          for (var i = 0; i < n.length; i++)
            e.$$(n[i]) && t.addDropZone(e.$$(n[i]).$view);
      t.attachEvent("onBeforeFileAdd", function(n) {
          var i = "" + c(e);
          return t.config.formData.target = i,
          t.config.urlData.target = i,
          t.config.upload = e.config.handlers.upload,
          e.callEvent("onBeforeFileUpload", [n])
        }),
        t.attachEvent("onAfterFileAdd", function(n) {
          e._uploaderFolder = null,
          n.oldId = n.id,
          e.add({
            id: n.id,
            value: n.name,
          ...
          e.config.uploadProgress && e.showProgress(e.config.uploadProgress),
          e._refreshActiveFolder()
        }),
        t.attachEvent("onUploadComplete", function(t) {
          e._uploadPopup && (e.getMenu().hide(), e._uploadPopup.hide()),
          e.hideProgress(),
          e.callEvent("onAfterFileUpload", [t])
        }),
        t.attachEvent("onFileUpload", function(t) {
          t.oldId && e.data.changeId(t.oldId, t.id),
          t.value && (e.getItem(t.id).value = t.value),
          e.getItem(t.id).type = t.type,
          e._refreshActiveFolder()
        }),
    ...
    function s(e, t) {
      t || (t = o(e.config.legacyUploader)),
      e._uploadPopup = webix.ui({view: "popup", padding: 0, width: 250, body: t}),
      e._uploader = e._uploadPopup.getBody(),
      e.attachEvent("onDestruct", function() {
    ...
    function u(e, t, n) {
      e.data.branch[t] || "folder" == e.getItem(t).type || (t = e.getParentId(t)),
      e._uploaderFolder = t,
      e._uploadPopup
        ? (e._uploadPopup.destructor(), s(e), r(e), e._uploadPopup.show(n, {
          x: 20,
          y: 5
        }))
